package Data::Semantic::URI::news;
...
use constant REGEXP_KEYS => qw(URI news);
...
Data::Semantic::URI::news - semantics for news URIs
...
=head1 SYNOPSIS
    ...
    my $obj = Data::Semantic::URI::news->new;
    if ($obj->is_well_formed($value)) { ... }

=head1 DESCRIPTION

Data::Semantic::URI::news inherits from L<Data::Semantic::URI>.
