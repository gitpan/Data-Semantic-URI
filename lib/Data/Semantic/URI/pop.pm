...
use constant REGEXP_KEYS => qw(URI POP);
...
Data::Semantic::URI::pop - semantics for POP URIs
...
=head1 SYNOPSIS
    ...
    my $obj = Data::Semantic::URI::pop->new;
    if ($obj->is_well_formed($value)) { ... }

=head1 DESCRIPTION

Data::Semantic::URI::pop inherits from L<Data::Semantic::URI>.
...
This document describes version 0.02 of L<Data::Semantic::URI::pop>.
