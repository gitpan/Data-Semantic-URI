...
use constant REGEXP_KEYS => qw(URI tv);
...
Data::Semantic::URI::tv - semantics for tv URIs
...
=head1 SYNOPSIS
    ...
    my $obj = Data::Semantic::URI::tv->new;
    if ($obj->is_well_formed($value)) { ... }

=head1 DESCRIPTION

Data::Semantic::URI::tv inherits from L<Data::Semantic::URI>.
...
This document describes version 0.01 of L<Data::Semantic::URI::tv>.
